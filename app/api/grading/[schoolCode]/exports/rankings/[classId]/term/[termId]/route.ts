...
import { exportRankingList, exportClassMarksheet } from '@/modules/grading-module/services/exportService';
...
export async function GET(_request: NextRequest, { params }: RouteParams) {
  ...
  try {
    const buffer = await exportRankingList(
      params.classId,
      params.termId,
    ...
    return new NextResponse(buffer, {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="rankings-${params.classId}-${params.termId}.xlsx"`,
      },
    });
  } catch (error) {
